...
public final class FragmentCommentsBinding implements ViewBinding {
  ...
  private FragmentCommentsBinding(@NonNull FrameLayout rootView, @NonNull RecyclerView rcView) {
  ...
  public static FragmentCommentsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentCommentsBinding((FrameLayout) rootView, rcView);
    }
