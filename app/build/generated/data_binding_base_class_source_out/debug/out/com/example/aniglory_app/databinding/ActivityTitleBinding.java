...
public final class ActivityTitleBinding implements ViewBinding {
  ...
  private ActivityTitleBinding(@NonNull CoordinatorLayout rootView, @NonNull Button bWatch,
      @NonNull ImageView backgroundPoster, @NonNull ImageView blur, @NonNull ImageView bookmarks,
      @NonNull Button button3, @NonNull ImageView close, @NonNull ImageView closeFull,
  ...
  public static ActivityTitleBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.bookmarks;
      ImageView bookmarks = ViewBindings.findChildViewById(rootView, id);
      if (bookmarks == null) {
        break missingId;
      }
      ...
      return new ActivityTitleBinding((CoordinatorLayout) rootView, bWatch, backgroundPoster, blur,
          bookmarks, button3, close, closeFull, descriptLayout, description, descriptionFull,
          linearLayout, linearLayout2, poster, posters, readFull, season, share, sheet, stars,
          textView14, textView5, title);
    }
