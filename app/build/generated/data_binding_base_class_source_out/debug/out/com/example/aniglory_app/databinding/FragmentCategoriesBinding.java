...
public final class FragmentCategoriesBinding implements ViewBinding {
  ...
  private FragmentCategoriesBinding(@NonNull FrameLayout rootView, @NonNull TextView categoryName,
  ...
  public static FragmentCategoriesBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentCategoriesBinding((FrameLayout) rootView, categoryName, rcView);
    }
